defmodule MyPersonalWeb.Api.MemberController do
  use MyPersonalWeb, :controller

  alias MyPersonal.Members
  alias MyPersonal.Members.Member

  action_fallback MyPersonalWeb.FallbackController
